...
(1, 'Puig', 2147483647, 255555555, 'Avellaneda 500', 'Enviar pagos por transferencia, en horario de banco (enviar comprobante al contacto), ALIAS: puig.SA'),
(2, 'Fragancia Premium', 1134785962, 299999999, 'Calle Libertad 1234', 'Enviar pagos por transferencia bancaria antes del día 15 de cada mes, ALIAS: fragancia.premium'),
(3, 'Perfumes Exclusivos', 1156784321, 233111111, 'Av. Belgrano 850', 'Pagos por depósito bancario, ALIAS: perfumes.exclusivos, enviar comprobante al contacto'),
(4, 'Aromas del Mundo', 1167895432, 2147483647, 'Calle San Martín 450', 'Pagos por transferencia bancaria o efectivo, ALIAS: aromas.mundo');
