...
class ProveedoresModelo extends Modelo{
    ...
    public function crear($id_proveedor, $nombre, $contacto, $cuit, $direccion, $informacion_pago){
        $query = $this->db->prepare('INSERT INTO proveedores(id_proveedor, nombre, contacto, cuit, direccion, informacion_pago) VALUES (?, ?, ?, ?, ?, ?)');
        $query->execute([$id_proveedor, $nombre, $contacto, $cuit, $direccion, $informacion_pago]);
    ...
    public function editar($nombre, $contacto, $cuit, $direccion, $informacion_pago){
        ...
        $query = $this->db->prepare('UPDATE proveedores SET contacto = ?, cuit = ?, direccion = ?, informacion_pago = ?,  WHERE id_proveedor = ?');
