    ...
    {   
        ...
        if (count($tablas) == 0) {
            $proveedores = [
                ...
                ['id_proveedor' => '2', 'nombre' => 'Puig', 'contacto' => '2494587965', 'cuit' => '24568625633', 'direccion' => 'Avellaneda 500', 'informacion_pago' => 'Enviar pagos por transferencia, en horario de banco (enviar comprobante al conacto), ALIAS: puig.SA'], 
                ['id_proveedor' => '3', 'nombre' => 'Fragancia Premium', 'contacto' => '1134785962', 'cuit' => '30495874612', 'direccion' => 'Calle Libertad 1234', 'informacion_pago' => 'Enviar pagos por transferencia bancaria antes del día 15 de cada mes, ALIAS: fragancia.premium'], ['id_proveedor' => '3', 'nombre' => 'Perfumes Exclusivos', 'contacto' => '1156784321', 'cuit' => '20587694321', 'direccion' => 'Av. Belgrano 850', 'informacion_pago' => 'Pagos por depósito bancario, ALIAS: perfumes.exclusivos, enviar comprobante al contacto']
