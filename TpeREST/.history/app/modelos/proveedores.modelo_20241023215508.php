...
class ProveedoresModelo{
    ...
    public function obtenerTodos($filtrarPorCuit=null, $ordenarPor=false, $orden= 'ASC') {
        ...
        /*SELECT * FROM proveedores ORDER BY nombre ASC; ORDENO ASCENDENTE CONSULTA SQL, con DESC ordeno descentente*/
