...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-10-2024 a las 21:34:12
...
INSERT INTO `proveedores` (`id_proveedor`, `nombre`, `contacto`, `cuit`, `direccion`, `informacion_pago`) VALUES
(1, 'Puig', 2494587965, 24568625633, 'Avellaneda 500', 'Enviar pagos por transferencia, en horario de banco (enviar comprobante al contacto), ALIAS: puig.SA'),
(2, 'Fragancia Premium', 1134785962, 30495874612, 'Calle Libertad 1234', 'Enviar pagos por transferencia bancaria antes del día 15 de cada mes, ALIAS: fragancia.premium'),
(3, 'Perfumes Exclusivos', 1156784321, 20587694321, 'Av. Belgrano 850', 'Pagos por depósito bancario, ALIAS: perfumes.exclusivos, enviar comprobante al contacto'),
(4, 'Aromas del Mundo', 1167895432, 27485963217, 'Calle San Martín 450', 'Pagos por transferencia bancaria o efectivo, ALIAS: aromas.mundo');
