...
### Filtrar por un campo de la tabla: 
La url para testear el filtrado es:(localhost/carpeta en la que este guardado el tp/) TpeREST/api/proveedores?cuit=299999999 (o el cuit que se quiera buscar).